...
Please do - watch this project if you would like to get updates on the process. - contribute best practices / ideas / documentation / code through issues or PRs \<3
...
2.  Search and replace the following values globally in all files
    ...
    | `{{sso-developer-group-id}}`        | Principal ID from Identity Provider’s group used by developers     | [Configure AWS SSO](#3-configure-aws-sso)                                 | 99672ac0cf-8495fd69-c57e-4214-88a4-b9f41eed0d32 |
